                  ...
                  <div className="max-w-7xl w-full mx-auto">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
                      ...
                      <div className="space-y-6 md:space-y-8">
                        {/* Event Title */}
                        <motion.h2
                          className="font-serif font-semibold text-5xl lg:text-6xl text-white leading-tight"
                          initial={{ opacity: 0, y: 20 }}
                          animate={{ opacity: 1, y: 0 }}
                          transition={{ duration: 0.6, delay: 0.1 }}
                        >
                          ...
                          <div className="flex flex-col gap-3">
                            ...
                            {eventData?.capacity && (
                              <div className="flex items-center gap-2">
                                ...
                                <span className="text-base">Capacity: {eventData.capacity}</span>
                              </div>
                            )}
                          </div>
                          ...
                          <div className="flex flex-col gap-3">
                            {eventData?.category && (
                              <div className="flex items-center gap-2">
                                ...
                                <span className="text-base">Category: {eventData.category.replace('-', ' ').split(' ').map(word => word.charAt(0).toUpperCase() + word.slice(1)).join(' ')}</span>
                              </div>
                            )}
                            {eventData?.organizer && (
                              <div className="flex items-center gap-2">
                                ...
                                <span className="text-base">{eventData.organizer}</span>
                              </div>
                            )}
                            {eventData?.contactEmail && (
                              <div className="flex items-center gap-2">
                                ...
                                <a href={`mailto:${eventData.contactEmail}`} className="text-base hover:text-emerald-300 transition-colors">
                                  {eventData.contactEmail}
                                </a>
                              </div>
                            )}
                            {eventData?.contactPhone && (
                              <div className="flex items-center gap-2">
                                <svg className="w-5 h-5 text-emerald-400 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                  ...
                                  <a href={`tel:${eventData.contactPhone}`} className="text-base hover:text-emerald-300 transition-colors">
                                  {eventData.contactPhone}
                                </a>
                              </div>
                            )}
                        ...
                        <motion.div
                          className="flex flex-col sm:flex-row gap-3 sm:gap-4 [&>*]:flex-1 [&>*]:min-w-[200px] pt-12"
                          initial={{ opacity: 0, y: 20 }}
                          animate={{ opacity: 1, y: 0 }}
                          transition={{ duration: 0.6, delay: 0.5 }}
                        >
